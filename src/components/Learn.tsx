...
const Learn: React.FC = () => {
  ...
  const handleStartInvesting = () => {
    ...
    if (!user) {
      showNotification('Please login to start investing', 'error');
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-center justify-center">
                <button 
                  ...
                  className="bg-gradient-to-r from-[#00E3A5] to-[#00c48f] text-white px-8 py-3 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-[#00E3A5]/50 hover:scale-105"
                >
                  Start Investing Now
                </button>
              </div>
